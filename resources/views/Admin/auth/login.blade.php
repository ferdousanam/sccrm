      ...
      <div class="login-content">
        <div class="col-md-10 col-md-offset-1">
          <form action="{{ route('admin.login') }}" class="login-form" method="post">
            ...
            <div class="row">
              <div class="col-xs-12">
                <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Username" name="email" required style="border: 1px solid #821745"/>
                @error('email')
              ...
              <div class="col-xs-12">
                <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Password" name="password" required style="border: 1px solid #821745"/>
                @error('password')
                <span class="form-text text-danger" role="alert">
                      <strong>{{ $message }}</strong>
                      </span>
