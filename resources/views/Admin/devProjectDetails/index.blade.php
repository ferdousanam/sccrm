        ...
        <div class="portlet-body">
          <div class="table-toolbar">
            <div class="row">
              ...
              <!--begin::Form-->
              <form id="menu-form" action="{{ route('project-details.update', $project->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                margin: 5px 5px 5px 0;">
                  ...
                  <div class="form-group row">
                    <label for="brand_logo" class="col-md-2 control-label">Brand Logo:</label>
                    <div class="col-md-8">
                      <div class="kt-avatar kt-avatar--outline">
                        <div style="
                border: 1px solid;
                ...
                margin: 5px 5px 5px 0;">
                  ...
                  <div class="form-group row">
                    <label for="app_icon" class="col-md-2 control-label">App Icon:</label>
                    <div class="col-md-8">
                      <div class="kt-avatar kt-avatar--outline">
                        <div style="
                border: 1px solid;
...
@push('scripts')
  <script>
      $(document).ready(function () {
          ...
          $('#project-details-sm').addClass('active');
      });
  </script>
@endpush
